    ...
    <div className=" h-full items-center flex justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      ...
      <div className=" md:hidden lg:flex xl:w-1/3 xl:justify-center">
        <Link href="/" className="text-sm rounded-md p-1 bg-black font-semibold flex items-center justify-center" >
          <span className="text-white mr-1 p-1">Mugil</span>
      ...
      <div className=" hidden md:flex gap-4 w-1/3 justify-end">
        <Link href="https://github.com/mugilanrs">
          <Image src="/github.png" width={24} height={24}/>
        </Link>
        <Link href="https://www.linkedin.com/in/mugilan-r-s-751781250/">
      ...
      <div className="md:hidden">
        {/* menu button */}
        <button className="w-10 h-8 flex flex-col justify-between z-50 relative bg" onClick={(()=>setOpen(!open))}>
